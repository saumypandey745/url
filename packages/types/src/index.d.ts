...
export type PermissionType = 'asset.read' | 'asset.write' | 'asset.verify' | 'asset.delete' | 'scan.run' | 'scan.read' | 'scan.cancel' | 'finding.read' | 'finding.update' | 'incident.read' | 'incident.manage' | 'recovery.execute' | 'recovery.verify' | 'report.generate' | 'team.manage' | 'settings.manage';
